        ...
        <div className="absolute h-full flex flex-col items-center justify-center">
            <div className="w-10/12 flex flex-col items-center justify-center gap-16">
                <div className="flex justify-center items-start gap-2 border border-white/50 text-white/50 rounded-full px-6 py-1">
                    <div className="bg-white/50 rounded-full max-h-2 max-w-2 min-h-2 min-w-2 mt-2"></div>
                    <div className="text-center">Next-generation Space Defense Technology</div>
                </div>
                <div className="text-3xl md:text-6xl font-bold rubik text-center mt-6">Satellites for Missile<div>Defense</div></div>
