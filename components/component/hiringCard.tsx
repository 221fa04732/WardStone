export default function HiringCard(){
    return(
        <div className="w-11/12 max-w-[1250px] flex flex-col justify-center items-center gap-2 md:gap-6 py-10 bg-[linear-gradient(135deg,#3883BC_0%,#001B2F_100%)] rounded-2xl my-16">
