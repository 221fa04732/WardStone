...
export default function NewsCard({data} : {data : newsType}){
    return(<div className="w-11/12 max-w-[1250px] h-full flex flex-col justify-center items-start gap-6 bg-[#090909] md:p-6 p-3 rounded-lg hover:scale-101 hover:border-b hover:border-r hover:border-blue-500 cursor-pointer">
