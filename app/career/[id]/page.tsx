...
export default function JobDetailPage(){  
    ...
    return(<div className='relative overflow-hidden w-full min-h-screen flex flex-col justify-start items-center'>
        <Navbar />
        <JobDetail job={job} />
        <div className={`absolute bg-blue-400 blur-3xl opacity-30 md:h-[400px] md:w-[400px] h-[200px] w-[200px] rounded-full -z-10 md:-right-[200px] md:bottom-[900px] -right-[100px] bottom-[1100px]`}></div>
        <Footer />
