...
export default function Admin(){
    ...
    return (<div className="min-h-screen flex flex-col justify-center items-center bg-[#00091a] text-white px-6 py-12 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-3xl">
            <Link href="/admin/newNews" className="group bg-[#00152f] p-8 rounded-2xl border border-blue-900 shadow-lg hover:bg-[#00204a] hover:shadow-blue-700/30 transition-all duration-300 flex justify-between items-center">
                <div>
            ...
            <Link href="/admin/newJob" className="group bg-[#00152f] p-8 rounded-2xl border border-blue-900 shadow-lg hover:bg-[#00204a] hover:shadow-blue-700/30 transition-all duration-300 flex justify-between items-center">
                <div>
